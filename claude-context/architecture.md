...
| api-pool | e2-medium (Spot) | 1 | notiflex-api(smb), Valkey |
| worker-pool | e2-standard-2 (Spot) | 1 | (ch8 Kafka 예정) |
| ops-pool | e2-small (Spot) | 1 | (ch8 Tempo·CronJob 예정) |
